...
export function Footer() {
  return (
    <footer className="border-t border-[#1c1c1c] bg-[#080808] mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="text-[#666666] hover:text-[#c4a35a] transition-colors"
          ...
          {/* Navigate */}
          <div>
            <h4 className="text-xs tracking-[0.2em] uppercase text-[#888888] mb-5 font-medium">
              Navigate
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-[#666666] hover:text-[#c4a35a] transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm text-[#666666]">Lagos, Nigeria</li>
              <li className="text-sm text-[#666666]">hello@quinnsartistry.ng</li>
              <li className="text-sm text-[#666666]">+234 800 000 0000</li>
        ...
        <div className="mt-12 pt-6 border-t border-[#1c1c1c] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#444444] tracking-wider">
