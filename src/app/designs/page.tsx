  ...
  return (
    <>
      ...
      <main className="pt-16 min-h-screen">
        {/* Header */}
        <div className="border-b border-[#1c1c1c] py-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-px w-8 bg-[#c4a35a]" />
              <span className="text-[10px] tracking-[0.3em] uppercase text-[#c4a35a]">Gallery</span>
            </div>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <h1 className="font-display text-6xl font-light text-[#f0ece4]">
                Design Library
              </h1>
        ...
        {/* Filters */}
        <div className="border-b border-[#1c1c1c] overflow-x-auto">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-24 text-[#444444]">
