        ...
        <div className="border-b border-[#1c1c1c] py-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase text-[#c4a35a]">Bespoke</span>
            </div>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <h1 className="font-display text-5xl md:text-6xl font-light text-[#f0ece4]">
                Custom Design
              </h1>
        ...
        <div className="border-b border-[#1c1c1c]">
          <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 sm:grid-cols-3 gap-px bg-[#1c1c1c]">
            {[
              ...
              <div key={item.step} className="bg-[#080808] px-6 py-4 flex items-start gap-4">
                <span className="font-display text-2xl text-[#2a2a2a]">{item.step}</span>
                <div>
                  <p className="text-sm text-[#f0ece4] mb-0.5">{item.label}</p>
